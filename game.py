...
def read_games_dict(json_filename=os.path.join(os.path.dirname(__file__), os.environ.get('GAMES_DB_FILE', 'known_games.json'))):
    with open(json_filename) as json_file:
        return json.load(json_file)


def write_games_dict(known_games_json, json_filename=os.path.join(os.path.dirname(__file__), os.environ.get('GAMES_DB_FILE', 'known_games.json'))):
